...
export class default_config {
    ...
    exaliases = {
        ...
        nosmoothscrollwizard: "composite reset <D-j>; reset <D-k>; reset <D-h>; reset <D-l>; reset <DC-d>; reset <DC-u>; reset <U-j>; reset <U-k>; reset <U-h>; reset <U-l>; reset <U-J>; reset <U-K>; reset <U-H>; reset <U-L>; reset <UC-u>; reset <UC-d>; reset <UC-U>; reset <UC-D>; reset j; reset k; reset h; reset l; reset <C-d>; reset <C-u>; reset <C-f>; reset <C-b>; fillcmdline_tmp 2000 original scroll binds restored",
