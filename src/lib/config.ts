...
export class default_config {
    ...
    exaliases = {
        ...
        tabgroupcollect: "tgroupcollect",
        tabgroupcollapse: "tgroupcollapse",
        tabgroupexpand: "tgroupexpand",
        tabgrouptoggle: "tgrouptoggle",
        tabgroupnext: "tgroupnext",
        tabgroupprev: "tgroupprev",
        tabgrouplast: "tgrouplast",
        tabgroupmove: "tgroupmove",
        tabgroupattach: "tgroupattach",
        tabgroupmovegroup: "tgroupmovegroup",
