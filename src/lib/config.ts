...
export class default_config {
    ...
    exaliases = {
        ...
        reibadailty: "jumble",
        smoothscrollwizard: "composite unbind h; unbind j; unbind k; unbind l; unbind <C-u>; unbind <C-d>; bind <D-j> scrollstart 0 1000; bind <D-k> scrollstart 0 -1000; bind <D-h> scrollstart -1000 0; bind <D-l> scrollstart 1000 0; bind <DC-d> scrollstart 0 5000; bind <DC-u> scrollstart 0 -5000; bind <U-j> scrollstop; bind <U-k> scrollstop; bind <U-h> scrollstop; bind <U-l> scrollstop; bind <U-J> scrollstop; bind <U-K> scrollstop; bind <U-H> scrollstop; bind <U-L> scrollstop; bind <UC-u> scrollstop; bind <UC-d> scrollstop; bind <UC-U> scrollstop; bind <UC-D> scrollstop; fillcmdline_tmp 2000 smooth scroll binds set up",
